        ...
        */
        ...
        function init()
        {
            ...
            if(e.options[e.selectedIndex].value == "Column")
            {
                displayMethode = "Column";
            }
            if(e.options[e.selectedIndex].value == "Music-Notes")
            {
                displayMethode = "Music-Notes";
            }
        ...
        function setColor(state) {
            switch(state)
            {
                case -1:ctx.strokeStyle = "#7d7d7d"; //grey
                        ctx.fillStyle = "#7d7d7d";
                        break;
                case  0:ctx.strokeStyle = "#E0777D"; //red
                        ctx.fillStyle = "#E0777D";
                        break;
                case  1:ctx.strokeStyle = "#D6FFB7"; //green
                        ctx.fillStyle = "#D6FFB7";
                        break;

                default: console.log("setColor(): default in Switch!!! state:"+state);
            }
        }
        ...
        function displayNotes()
            {   
                for(let x in values){
                    ...
                    console.log("x: "+ x +" mod:"+mod +" floor:"+Math.floor(values[x]/12));
                    let tag = true;
                    //without #
        ...
        function drawNote(x,value,tag){
            ...
            setColor(states[x]);
            ctx.beginPath();
            ctx.arc(((x)*colWidth)+colWidthC,canvas.height/2-y,colWidthC/2,0,2*Math.PI);
        ...
        function draw()
        {
            ...
            if(displayMethode == "Column")
            {
                drawInColumn();
            }
            if(displayMethode == "Music-Notes")
            {
                drawInNotes();
            }
        ...
        function drawInColumn()
        {
            for(let x in values)
            {
                ...
                ctx.fillRect(0,x*colWidth+colWidth/4,values[x]*10,colWidth/2);
                ctx.fill();
            }
        }
